...
@Module({ imports: [
  ...
  TypeOrmModule.forFeature([Actionplan_master,master_zp,masterdepartment,master_subdivision,master_ps,gram_panchayat,masterdepartment,mastersector,master_urban]),
