...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([Contractor_master,master_zp,masterdepartment,master_subdivision,master_ps,gram_panchayat,masterdepartment,MasterScheme,MasterSchemeExpenduture,master_urban,DemandMaster,Employment,master_users,masterscheme_2024_2025,MasterScheme_draft]),
