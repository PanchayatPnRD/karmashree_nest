...
@Module({  imports: [
    ...
    TypeOrmModule.forFeature([user_role,master_zp,master_subdivision,master_ps,mastersector,masterdepartment,gram_panchayat,masterdesignation,master_urban,pedestalMaster]),
